...
> = {
  ...
  twitter: { label: "Twitter / X", type: "url", placeholder: "https://x.com/...", color: "#111111", icon: FaXTwitter },
  youtube: { label: "YouTube", type: "url", placeholder: "https://youtube.com/...", color: "#FF0000", icon: FaYoutube },
  discord: { label: "Discord", type: "username", placeholder: "userid", prefix: "https://discord.com/users/", color: "#5865F2", icon: FaDiscord },
